...
;(function () {
  ...
  /** @private */
  emoji.prototype.replacement = function (idx, actual, wrapper, variation, compact) {
    var self = this;
    ...
    if (self.supports_css) {
      if (self.use_sheet && px != null && py != null) {
        ...
        if (compact)
        return '<span class="emoji-inner" style="' + style + '"' + title + ' data-codepoints="' + full_idx + '">' + text + '</span>' + extra;
