...
//4.2 Visa card 
myApp.getController('VisaCardController',
...
function ($scope, $rootScope, $http, _userManager, _sweetAlert, _authService, alertService, VaultInformationService, CountryCityService, dateFilter, DocumentVaultService) {
    ...
    "use strict";
    var BasicInfo = VaultInformationService.VaultInformation.groupFinancial.value.visaCard;
    ...
    $scope.InitData = function () {
        ...
        $(BasicInfo.value).each(function (index, object) {
            ...
            var _jspath = "/Financial/Visa card/" + BasicInfo.value[index]._id;
            var today = new Date();
            var expiryNo = false;
        ...
        maxindex = maxindex + 1;
        $rootScope._newJspath = "/Financial/Visa card/" + maxindex;
        $scope._new =
           {
               '_id': maxindex,
               'IsEdit': false,
        ...
        $scope.removeFormDoc = function (_value) {
            ...
            var _jsp = "/Financial/Visa card/" + _value._id;
    ...
    $scope.Save = function () {
        ...
        //Save
        VaultInformationService.VaultInformation.groupFinancial.value.visaCard = BasicInfo;
        VaultInformationService.VaultInformation.groupFinancial.value.visaCard.value = lstFormSave;
