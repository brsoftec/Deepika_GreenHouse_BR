...
myApp.getController('PermanentCardController',
...
function ($scope, $rootScope, $http, _userManager, _sweetAlert, _authService, alertService, VaultInformationService, CountryCityService, dateFilter, DocumentVaultService) {
    ...
    "use strict";
    var BasicInfo = VaultInformationService.VaultInformation.groupGovernmentID.value.permanentResidenceCard;
    ...
    $scope.InitData = function () {
        ...
        $(BasicInfo.value).each(function (index, object) {
            ...
            var _jspath = "/Government ID/Permanent Residence Card/" + BasicInfo.value[index]._id;
            var today = new Date();
            var expiryNo = false;
            // indefinite
            ...
            $scope._listForm.push({
                ...
                country: BasicInfo.value[index].country,
        ...
        maxindex = maxindex + 1;
        $rootScope._newJspath = "/Government ID/Permanent Residence Card/" + maxindex;
        $scope._new =
           {
               '_id': maxindex,
               'IsEdit': false,
        ...
        $scope.removeFormDoc = function (_value) {
            ...
            var _jsp = "/Government ID/Permanent Residence Card/" + _value._id;
    ...
    $scope.$on('permanentResidenceCard', function () {
        $scope.InitData();
    });
    $scope.InitData();
    $scope.Edit = function () {
    ...
    $scope.Save = function () {
        ...
        $($scope._listForm).each(function (index, object) {
            ...
            lstFormSave.push({
                ...
                country: $scope._listForm[index].country,
        ...
        //Save
        VaultInformationService.VaultInformation.groupGovernmentID.value.permanentResidenceCard = BasicInfo;
        VaultInformationService.VaultInformation.groupGovernmentID.value.permanentResidenceCard.value = lstFormSave;
        ...
        VaultInformationService.SaveVaultInformation(VaultInformationService.VaultInformation,
            VaultInformationService.VaultInformation._id).then(function (response) {
                $scope.IsEdit = false;
                $scope._new = "";
                $rootScope.$broadcast('permanentResidenceCard');
