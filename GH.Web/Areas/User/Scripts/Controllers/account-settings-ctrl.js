...
myApp.getController('AccountSettingsController', function ($scope, $location, $anchorScroll) {
    ...
    $scope.updateViewPreference = function (pref) {
        ...
        switch (pref) {
            ...
            case 'introVault':
                ...
                prefValue = $scope.settings.viewprefs.showIntroVault;
                break;
            case 'introBusiness':
                prefName = 'ShowIntroBusiness';
                prefValue = $scope.settings.viewprefs.showIntroBusiness;
                break;
        }
        ...
        if (prefName) {
            $http.post('/Api/AccountSettings/ViewPreference', {
                ...
                console.log('Error saving view preferences', error);
            });
        }
    }
