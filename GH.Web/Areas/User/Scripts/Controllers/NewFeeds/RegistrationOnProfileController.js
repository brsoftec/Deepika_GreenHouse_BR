...
myApp.controller('RegistrationOnProfileController',
['$scope', '$rootScope', '$uibModalInstance', '$uibModal', '$http', 'UserManagementService', 'SweetAlert', 'AuthorizationService', 'alertService', 'NotificationService', 'registerPopup', 'SmSAuthencationService', 'interactionFormService', 'fileUpload',

function ($scope, $rootScope, $uibModalInstance, $uibModal, $http, userManager, sweetAlert, authService, alertService, notificationService, registerPopup, SmSAuthencationService, interactionFormService, fileUpload) {
    $scope.messageBox = "";
    $scope.alerts = [];
    ...
    $scope.vaildfiled = function (field) {
        ...
        switch (field.type) {
            ...
            case "address":
                ...
                break;
            case "location":
                if (field.model == null || field.model.country == "" || field.model.city == null)
                    isvalid = false;
                break;
            case "date":
