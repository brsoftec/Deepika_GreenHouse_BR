...
myApp.getController('PushVaultUserController', ['$scope', '$rootScope', '$sce', 'BusinessAccountService', 'SweetAlert', 'UserManagementService', '$uibModal', '$http', function ($scope, $rootScope, $sce, _baService, _sweetAlert, UserManagementService, $uibModal, $http) {
    $scope.profile = {};
    $scope.pushtovaults = [];
    ...
    $scope.loadPushVault = function () {
        $http.get('/Api/Account/GetPushVaultUser')
            .success(function (rs) {
        ...
        $http.post("/api/CampaignService/GetUserInformationForCampaignEmpty", data)
                .success(function (response) {
                    ...
                    var modalInstance = $uibModal.open({
                        ...
                        controller: 'RegistrationOnPushToVaultUserToUserController',
                        size: "",
                        backdrop: 'static',
