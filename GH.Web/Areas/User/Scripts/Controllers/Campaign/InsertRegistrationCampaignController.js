...
myApp.getController('InsertRegistrationCampaignController',
...
function ($scope, $rootScope, $http, userManager, sweetAlert, authService, alertService, informationVaultService, notificationService, countryCityService, fileUpload, dateFilter, CampaignService, CommonService, $uibModal, $document, $timeout, interactionFormService) {
    ...
    $scope.InitData = function () {
        ...
        if (campaign.qrCode.AllowCreateQrCode != undefined && campaign.qrCode.AllowCreateQrCode != null)
            ...
            $scope.qr.AllowCreateQrCode = false;
    ...
    $scope.showhidebutton = function () {
        ...
        if (fullcampign._id != "" && $scope.action != "clone") {
            ...
            if (campaign.status == "Template") {
                ...
                $scope.pageTitle = "INTERACTION: " + campaign.name;
                $scope.isshowstatus = false;
                $scope.isshowdraff = true;
                $scope.isshowbttemplate = false;
                $scope.isshowtemplate = true;
            ...
            $scope.isshowbackcampaign = false;
            $scope.isshowtemplate = true;
            $scope.pageTitle = "NEW CAMPAIGN - REGISTRATION";
        }
    }
    ...
    $scope.GetTemplate = function () {
        var data = new Object();
        $http.post('/api/CampaignService/GetCampaignRegistrationTemplate', data)
             .success(function (response) {
    ...
    $scope.addDoc = function () {
        ...
        var field = {
            qa: true,
            type: 'doc',
            displayName: 'Custom Upload File',
    ...
    $scope.formFieldJsPath=function(jsonpath){
        ...
        switch (result) {
            ...
            case "governmentID passportID - Nationality":
                result = "Government ID - Passport ID - Nationality";
                break;
            case "governmentID passportID - Card number":
                result = "Government ID - Passport ID - Card number";
                break;
            case "governmentID passportID - Issued date":
                result = "Government ID - Passport ID - Issued date";
                break;
            case "governmentID passportID - Photo":
                result = "Government ID - Passport ID - Photo";
                break;

            case "governmentID passportID - Expiry date":
                result = "Government ID - Passport ID - Expiry date";
                break;
            case "governmentID passportID - Issued by":
                result = "Government ID - Passport ID - Issued by";
                break;
            case "governmentID passportID - Issued in":
                result = "Government ID - Passport ID - Issued in";
                break;
                //
            case "governmentID nationalID - Description":
                result = "Government ID - National ID - Description";
                break;
            case "governmentID nationalID - First name":
                result = "Government ID - National ID - First name";
                break;
            case "governmentID nationalID - Last name":
                result = "Government ID - National ID - Last name";
                break;
            case "governmentID nationalID - Race":
                result = "Government ID - National ID - Race";
                break;
            case "governmentID nationalID - Address":
                result = "Government ID - National ID - Address";
                break;

            case "governmentID nationalID - Country":
                result = "Government ID - National ID - Country";
                break;
            case "governmentID nationalID - Issued date":
                result = "Government ID - National ID - Issued date";
                break;
            case "governmentID nationalID - Expiry date":
                result = "Government ID - National ID - Expiry date";
                break;
            case "governmentID nationalID - Photo":
                result = "Government ID - National ID - Photo";
                break;
    ...
    $scope.InitData3 = function () {
        ...
        $scope.AllowCreateQrCode3 = campaign.qrCode.AllowCreateQrCode;
        $scope.PublicURL3 = campaign.qrCode.PublicURL;
        $scope.UserCost = campaign.usercode + " " + campaign.criteria.spend.currentcy;
        $scope.Usercodetype = campaign.usercodetype;
    }
    ...
    $scope.Back3 = function () {
        $scope.$parent.step = 2;
        /*  $.each($scope.foermFields2, function (index, field) {
    ...
    $scope.Done3 = function () {
        ...
        if ($scope.formEntries.length > 0)
        {
            ...
            //
            //campaign.fields.sort(function (a, b) {
