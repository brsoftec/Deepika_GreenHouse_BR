...
['$scope', '$rootScope', '$uibModalInstance', '$uibModal', '$http', 'formService', 'UserManagementService', 'SweetAlert', 'AuthorizationService', 'alertService', 'NotificationService', 'registerPopup', 'SmSAuthencationService','fileUpload',

function ($scope, $rootScope, $uibModalInstance, $uibModal, $http, formService, userManager, sweetAlert, authService, alertService, notificationService, registerPopup, SmSAuthencationService,fileUpload) {
    $scope.messageBox = "";
    $scope.alerts = [];
